...
<aside class="sidebar sidebar-expand-lg sidebar-dark">
    ...
    <nav class="sidebar-navigation">
        ...
        <ul class="menu">
            ...
            @canany(['list-pos', 'create-pos', 'list-return'])
            ...
            @can('stock')
                <li class="menu-item {{ Request::routeIs('stock.*') ? 'active open' : '' }}">
                    ...
                    <ul class="menu-submenu">
                        <li class="menu-item {{ Request::routeIs('stock.create') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('stock.create') }}">
                                <span class="dot"></span>
                                <span class="title">Add Stock</span>
                            </a>
                        </li>

                        <li class="menu-item {{ Request::routeIs('stock.history') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('stock.history') }}">
                                <span class="dot"></span>
                                <span class="title">Stock Addition History</span>
                            </a>
                        </li>

                        <li class="menu-item {{ Request::routeIs('stock.transfer_index') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('stock.transfer_index') }}">
                                <span class="dot"></span>
                                <span class="title">Transfer Stock</span>
                            </a>
                        </li>

                        <li class="menu-item {{ Request::routeIs('stock.transfer_history') ? 'active' : '' }}">
                            <a class="menu-link" href="{{ route('stock.transfer_history') }}">
                                <span class="dot"></span>
            ...
            <li class="menu-category">Sales Setup</li>

            @can('list-sales-designation')
                <li class="menu-item {{ Request::routeIs('sales-designation.*') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('sales-designation.index') }}">
                        <img src="{{ asset('dashboard/sidebar_icons/bank_card.svg') }}" alt=""
                            class="sidebar_icon icon">
                        <span class="title">Sales Designation</span>
                    </a>
                </li>
            @endcan

            @can('list-sales-area')
                <li class="menu-item {{ Request::routeIs('sales-area.*') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('sales-area.index') }}">
                        <img src="{{ asset('dashboard/sidebar_icons/bank_card.svg') }}" alt=""
                            class="sidebar_icon icon">
                        <span class="title">Sales Area</span>
                    </a>
                </li>
            @endcan

            @canany(['list-sales-member', 'create-sales-member', 'edit-sales-member'])
                <li class="menu-item {{ Request::routeIs('sales-member.*') ? 'active open' : '' }}">
                    <a class="menu-link" href="#">
                        <img src="{{ asset('dashboard/sidebar_icons/damage.svg') }}" alt=""
                            class="sidebar_icon icon">
                    ...
                    <ul class="menu-submenu">
                        @can('create-sales-member')
                            <li class="menu-item {{ Request::routeIs('sales-member.create') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('sales-member.create') }}">
                                    <span class="dot"></span>
                        ...
                        @can('list-sales-member')
                            <li class="menu-item {{ Request::routeIs('sales-member.index') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('sales-member.index') }}">
                                    <span class="dot"></span>
                                    <span class="title">Sales Team</span>
                                </a>
                            </li>
            ...
            @canany(['list-sales-target', 'create-sales-target', 'edit-sales-target'])
                <li class="menu-item {{ Request::routeIs('sales-target.*') ? 'active open' : '' }}">
                    <a class="menu-link" href="#">
                        <img src="{{ asset('dashboard/sidebar_icons/damage.svg') }}" alt=""
                            class="sidebar_icon icon">
                    ...
                    <ul class="menu-submenu">
                        @can('create-sales-member')
                            <li class="menu-item {{ Request::routeIs('sales-target.create') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('sales-target.create') }}">
                                    <span class="dot"></span>
                                    <span class="title">Add Target</span>
                                </a>
                            </li>
                        @endcan

                        @can('list-sales-member')
                            <li class="menu-item {{ Request::routeIs('sales-target.index') ? 'active' : '' }}">
                                <a class="menu-link" href="{{ route('sales-target.index') }}">
                                    <span class="dot"></span>
                                    <span class="title">Sales Target</span>
                                </a>
                            </li>
            ...
            @canany(['target_report', 'today_report', 'current_month_report', 'summary_report', 'daily_report',
                'customer_due_report', 'supplier_due_report', 'low_stock_report', 'top_customer_report',
                'top_product_report', 'top_product_all_time_report', 'purchase_report', 'customer_ledger',
                'supplier_ledger', 'profit_loss_report'])
                ...
                @can('target_summary')
                <li
                    class="menu-item {{ Request::routeIs('target_summary') || Request::routeIs('target_summary') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('target_summary') }}">
                        <img src="{{ asset('dashboard/sidebar_icons/24hr.svg') }}" alt=""
                            class="sidebar_icon icon">
                        <span class="title">Yearly Target Report</span>
                    </a>
                </li>
            @endcan
                @can('target_report')
                    <li
                        class="menu-item {{ Request::routeIs('target_report') || Request::routeIs('target_report.member') ? 'active' : '' }}">
                        <a class="menu-link" href="{{ route('target_report') }}">
                            <img src="{{ asset('dashboard/sidebar_icons/24hr.svg') }}" alt=""
                                class="sidebar_icon icon">
                            <span class="title">Member Wise Report</span>
                        </a>
                    </li>
                @endcan
                @can('target_report')
                    <li
                        class="menu-item {{ Request::routeIs('target_report') || Request::routeIs('target_report.daily_sale_collection') ? 'active' : '' }}">
                ...
                {{-- <li class="menu-item {{ Request::routeIs('report.all_sales') ? 'active' : '' }}">
                    <a class="menu-link" href="{{ route('report.all_sales') }}">

                        <img src="{{ asset('dashboard/sidebar_icons/list_high_to_low.svg') }}" alt=""
                            class="sidebar_icon icon">
                        <span class="title">All Sales Report</span>
                    </a>
                </li> --}}
