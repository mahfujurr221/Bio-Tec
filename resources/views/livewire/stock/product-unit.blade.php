    ...
    <div class="form-group">
      ...
      <div class="form-group">
            ...
            {{-- @if($main_qty) --}}
                ...
                <input type="number" value="" class="form-control col main_qty mr-1" name="main_unit_qty">
            {{-- @endif --}}

            @if($product->sub_unit_id)
                <label class="mr-1">{{ $product->sub_unit->name }}:</label>
                <input type="number" value="" class="form-control col sub_qty mr-1" name="sub_unit_qty">
            @endif
