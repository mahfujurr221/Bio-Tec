    ...
    <div class="row justify-content-center">
        <div class="col-md-7 card card-body print">
            <div id="print-area">
                ...
                <div class="address">
                    Address : <span>{{ $pos->customer ? $pos->customer->sales_member->address : 'Walking Customer' }}</span>
                </div>
                <div class="mobile-no">
                    Mobile : <span>{{ $pos->customer ? $pos->customer->sales_member->phone : 'Walking Customer' }}</span>
                </div>
