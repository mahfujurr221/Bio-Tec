    ...
    <div class="row justify-content-center">
        <div class="col-md-7 card card-body print">
            <div id="print-area">
                ...
                <div class="name">
                    Salesman Name : <span>{{ $pos->customer ? $pos->customer->sales_member->name : 'Walking Customer' }}</span>
                </div>
                <div class="address">
                    Address : <span>{{ $pos->customer ? $pos->customer->sales_member->address : 'Walk-in Customer'}}</span>
                </div>
                <div class="mobile-no">
                    Mobile : <span>{{ $pos->customer ? $pos->customer->sales_member->mobile : 'Walk-in Customer'}}</span>
                </div>

                <div class="cus_info">
                    Customer Name : <span>{{ $pos->customer->name}}</span>
                </div>
