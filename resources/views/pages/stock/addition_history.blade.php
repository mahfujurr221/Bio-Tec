...
@section('title', 'Stock Addition History')

@section('page-header')
<header class="header bg-ui-general">
     <div class="header-info">
          <h1 class="header-title">
               <strong>Stock Addition History</strong>
          </h1>
     </div>
</header>
@endsection
    ...
    <div class="card print_area">
     <div class="row">
         <div class="col-12" style="display:flex; justify-content:space-between">
             <h4 class="card-title"><strong>Stock Addition History</strong></h4>
          ...
          <div class="card-body">
               ...
               <div class="">
                    ...
                    <div class="print_hidden">
                        {!! $additions->appends(Request::except("_token"))->links() !!}
                    </div>
               </div>
               @else
