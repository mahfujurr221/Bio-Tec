    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <span class=""><label><input type="checkbox" id="select-all" class="mr-2 ml-2">Select
                        All</label></span>
                ...
                <form action="{{ route('role_permissions.update', $role) }}" method="POST" class="form-row">
                    ...
                    @foreach ($permission_groups as $key => $permissions)
                        <div class="card col-md-6 feature_group">
                            <div class="card-header">
                                <h4 style="text-transform: capitalize" style="display: inline;">
                                    {{ str_replace('_', ' ', $key) }}</h4>
                                <span class=""><label><input type="checkbox" class="mr-2 ml-2 select_group">Select
                                        Section</label></span>
                            </div>
                            <div class="card-body">
