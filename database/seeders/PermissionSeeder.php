...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $resourece_features['warehouse'] = ['l', 'c', 'u', 'd'];
        ...
        // Report
        $other_permissions['target_report'] = 'report';
        $other_permissions['target_summary'] = 'report';
        ...
        $resourece_features['sales-designation'] = ['l', 'c', 'u', 'd'];
        $resourece_features['sales-area'] = ['l', 'c', 'u', 'd', 'r'];
        $resourece_features['sales-member'] = ['l', 'c', 'u', 'd'];
        $resourece_features['sales-target'] = ['l', 'c', 'r', 'u', 'd'];
